<template>
  <aside>
    ...
    <div class="d-flex align-items-center" style="position: absolute; bottom: 10px; z-index: 10;">
      <button @click="$router.push({ name: 'home'}), setMappedTable(), setSavedColumns(), setFilters()" type="button" class="btn btn-secondary d-flex justify-content-center align-items-center fa-rotate-180" title="Drop Connection">
